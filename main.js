(self["webpackChunktest_me"] = self["webpackChunktest_me"] || []).push([["main"],{
...
let AppComponent = class AppComponent {
    constructor() {
        this.appPages = [
            { title: 'General', url: '/folder/General', icon: 'documents' },
